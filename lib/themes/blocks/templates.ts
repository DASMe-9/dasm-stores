...
function productsPage(headerTitle: string, cols: number): Block[] {
  return [
    ...
    b("features", { items: ["خيارات شحن واضحة", "دفع آمن", "سياسة استرجاع معلنة", "دعم العملاء"] }),
...
export const STORE_TEMPLATES: StoreTemplate[] = [
  {
    ...
    landing: [
      ...
      b("features", { items: ["قطع أصلية", "خيارات شحن واضحة", "ضمان سنة", "دعم فني"] }),
  ...
  },
  {
    ...
    landing: [
      ...
      b("features", { items: ["أصلي ١٠٠٪", "دفع آمن", "خيارات شحن واضحة", "تقسيط"] }),
  ...
  },
  {
    ...
    landing: [
      ...
      b("features", { items: ["تشكيلة واسعة", "أسعار منافسة", "خيارات شحن واضحة", "سياسة استرجاع معلنة"] }),
