...
| 2026-08-05 | competitors/2026-32 | **توصيات منتجات بالذكاء الاصطناعي:** Salla Twilight v2.14.490 أضافت AI-powered product recommendation APIs — شبكة "مقترحة لك" تتغير بحسب سلوك المستخدم. dasm-stores تعتمد حاليًا على `sort=featured` فقط. التطبيق يتطلب events tracking + recommendation API (بنية تحتية). | `app/page.tsx` + `lib/api-server.ts` | 🔴 طويل المدى | مؤجلة — يتوقف على قرار استراتيجي |
| 2026-08-05 | competitors/2026-32 | **Announcement Bar (شريط إعلانات علوي):** Zid وShopify يوفران شريطاً علوياً رفيعاً قابلاً للتهيئة من لوحة التحكم. فرصة منخفضة التعقيد لإضافة رسائل عروض وحملات تسويقية دون تعديل Hero. | `components/store/StoreHeader.tsx` | 🟢 منخفضة | مؤجلة |
