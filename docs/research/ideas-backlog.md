...
| 2026-06-15 | competitors/2026-28 | **Cart Confirmation Popup:** Salla يعرض popup خفيف بعد إضافة منتج للسلة بدلاً من فتح drawer كامل. الفكرة تحتاج مراجعة تدفق التسوق حتى لا تكرر `CartDrawer.tsx`. | `components/cart/CartToast.tsx` + `store/cartStore.ts` | 🟡 متوسطة | **مُحوَّلة إلى spec** `cart-toast-2026-06-19.md` |
...
| 2026-06-19 | competitors/2026-30 | **Salla Quick Buy — Checkout مباشر:** `<salla-quick-buy>` ينقل المتسوق لصفحة الدفع متجاوزاً السلة. dasm-stores لا يوفر مسار checkout مباشر. يحتاج تقييم: هل يُفيد أهداف المنصة أم يُضعف cart experience? | `app/[slug]/products/[productId]/page.tsx` | 🟡 متوسطة | مؤجلة — تقييم مطلوب |
| 2026-06-19 | competitors/2026-30 | **Product Disclosures (Shopify Dawn 15.5):** قسم نص إفصاحي/قانوني أسفل وصف المنتج. مفيد لمتاجر الأغذية/المستحضرات/الإلكترونيات. يحتاج دعم API: حقل إضافي في `product.metadata` أو `product.description_extra`. | `app/[slug]/products/[productId]/page.tsx` | 🔵 منخفضة | مؤجلة — دعم API مطلوب |
