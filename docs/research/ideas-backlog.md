...
| 2026-06-16 | competitors/2026-29 | **معلومات شحن/استلام على صفحة تفصيل المنتج:** Salla أضافت مكوّن `salla-fulfillment-methods` يعرض خيارات توصيل/استلام قبل زر "أضف للسلة". dasm-stores لا يعرض أي معلومة شحن على صفحة المنتج. يتوقف على حقول API: يحتاج تحقق من بيانات متاحة في `getProducts()` response. | `app/[slug]/products/[productId]/page.tsx` | 🟡 متوسطة | **محوَّل لـ spec** `product-detail-shipping-disclosure-2026-07-11.md` (W30) |
| 2026-07-11 | competitors/2026-30 | **Headless Cart / AI Cart Interactions:** Shopify Dawn v15.5.0 أضاف دعم تفاعلات سلة من apps/agents/AI دون page reload. النمط يتطلب مراجعة بنية `CartDrawer.tsx` وتحويلها من navigation-based إلى state-driven. قرار بنية كبير قبل البدء. | `components/cart/CartDrawer.tsx` + `store/cartStore.ts` | 🔵 مستقبلي | مؤجلة — يتطلب قرار بنية |
