...
| 2026-07-19 | competitors/2026-30 | **تقييمات متعددة الأبعاد + رفع صور:** Salla Twilight v2.14.490 أضافت multi-factor ratings (جودة/تسليم/تغليف) ورفع صور في المراجعة وتعديل/حذف المراجعة بعد النشر. `ProductReviews.tsx` يعرض المراجعات فقط بدون هذه الإمكانيات. | `components/product/ProductReviews.tsx` | 🟡 متوسطة | مؤجلة |
