...
| 2026-06-28 | competitors/2026-30 | **قسم إفصاحات المنتج (Product Disclosures):** Shopify Dawn 15.5 أضافت block جديد لعرض إفصاحات قانونية ومعلومات سلامة على صفحة تفاصيل المنتج. السوق السعودي يشترط إفصاحات للأغذية والأدوية. `app/[slug]/products/[productId]/page.tsx` لا يعرض أي قسم من هذا النوع. التنفيذ يتوقف على إضافة حقل `disclosure_text` أو ما يعادله في بيانات المنتج من الـ API. | `app/[slug]/products/[productId]/page.tsx` | 🟡 متوسطة | مؤجلة — تحقق حقل API مطلوب |
