...
| 2026-07-11 | competitors/2026-30 | **Product Disclosures block على صفحة تفصيل المنتج:** Shopify Dawn 15.5.0 أضاف section وblock لعرض إفصاحات المنتج (مكوّنات، تحذيرات، إرشادات استخدام) بين الـ media وزر "أضف للسلة". ذو صلة بالأغذية والعطور والمنتجات الصحية. يتوقف على وجود حقل بيانات في API (`product.description_html` أو metafield خاص). | `app/[slug]/products/[productId]/page.tsx` | 🟡 متوسطة | مؤجلة — تحقق API مطلوب |
