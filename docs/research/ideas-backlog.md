...
| 2026-06-15 | competitors/2026-28 | **Cart Confirmation Popup:** Salla يعرض popup خفيف بعد إضافة منتج للسلة بدلاً من فتح drawer كامل. الفكرة تحتاج مراجعة تدفق التسوق حتى لا تكرر `CartDrawer.tsx`. | `components/cart/CartToast.tsx` + `store/cartStore.ts` | 🟡 متوسطة | **تحوّل لـ spec** — `docs/specs/cart-confirmation-toast-2026-07-02.md` |
...
| 2026-07-02 | competitors/2026-30 | **Product Disclosures على صفحة المنتج:** Shopify Dawn v15.5.0 أضافت block لعرض إفصاحات قانونية/مادة/عناية على صفحات المنتج. `app/[slug]/products/[productId]/page.tsx` لا يعرض أي بيانات إضافية. يتوقف على تحقق من حقول API: هل `product.description` أو حقول مخصصة تحتوي بيانات قابلة للعرض كـ disclosures. | `app/[slug]/products/[productId]/page.tsx` | 🟡 متوسطة | مؤجلة — تحقق API مطلوب |
