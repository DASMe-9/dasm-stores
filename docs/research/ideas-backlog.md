...
| 2026-06-23 | competitors/2026-30 | **Salla Instant Purchase — شراء مباشر بدون سلة:** Salla أطلقت "الشراء السريع" الذي يتجاوز السلة كلياً ويوجّه المتسوق لصفحة الدفع مباشرةً من رابط أو زر المنتج. مختلف عن Quick Add (spec W28) الذي يُضيف للسلة فقط. يحتاج endpoint خاص للـ instant checkout + دراسة تأثيره على تدفق الدفع الحالي. | `app/[slug]/products/[productId]/page.tsx` + API جديد | 🔴 عالية (تنافسياً) لكن | مؤجلة — يتوقف على تقييم backend |
