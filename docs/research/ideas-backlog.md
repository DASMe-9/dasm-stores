...
| 2026-06-21 | competitors/2026-30 | **Carousel navigation من خيارات اللون:** Salla Twilight v2.14.420 أضافت ربطاً مباشراً بين swatch اللون وصورة المنتج في الـ carousel — الضغط على لون يغيّر الصورة فوراً. dasm-stores لا يعرض خيارات variants على بطاقة المنتج أو الصفحة التفصيلية. يتطلب: (1) التحقق من دعم API لـ variant-to-image mapping، (2) إضافة swatches لـ ProductCard أو `ProductPurchaseSection.tsx`. | `components/product/ProductPurchaseSection.tsx` + `components/product/ProductCard.tsx` | 🟡 متوسطة | مؤجلة — تحقق API مطلوب |
