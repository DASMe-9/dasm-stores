...
| 2026-08-10 | baseline-drift-2026-08-10 | **StoreInfoCard — زر سلة أساسي غائب:** بطاقة المتجر في صفحة المتجر الفرعي (`StoreHeader.tsx` سطر 179–225) تحتوي ShareButton، WhatsApp، ProfileFollow — لكن لا يوجد زر "اضف للسلة" أو "تسوق الآن" كما هو في الـ baseline. يُعزز نية الشراء المباشر. | `components/store/StoreHeader.tsx` | 🟡 متوسطة | مؤجلة |
| 2026-08-10 | baseline-drift-2026-08-10 | **قرار تصميمي معلّق — Hero elevation:** كوميت `013f987` (2026-07-30) غيّر الـ Hero من بطاقة داكنة مع HeroScene إلى شريط فاتح مع CommercePassport. هذا قد يكون قراراً مُعتمداً أو drift يجب استرجاعه. يحتاج فريق التصميم لتحديد: (أ) الاسترجاع إلى HeroScene، أو (ب) تحديث `docs/design/baseline/marketplace-home.png`. | `app/page.tsx` + `docs/design/baseline/` | 🔴 عالية | قرار فريق مطلوب |
