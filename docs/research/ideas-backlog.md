...
| 2026-07-06 | competitors/2026-30 | **Checkout Popup Modal (Zid-inspired):** عرض صفحة checkout داخل modal دون مغادرة الصفحة الحالية — تجربة أسرع وأقل احتكاكاً للموبايل. يتطلب إعادة هيكلة `CartDrawer.tsx` وإضافة stepper للشحن والدفع. تأثير متوسط على التحويل، جهد هندسي عالٍ — تحتاج مناقشة معمارية أولاً. | `app/[slug]/checkout/page.tsx` + `components/cart/CartDrawer.tsx` | 🟠 عالية | مؤجلة — مناقشة معمارية مطلوبة |
