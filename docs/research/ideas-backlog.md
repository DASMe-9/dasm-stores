...
| 2026-07-26 | competitors/2026-30 | **توصيات منتجات بالذكاء الاصطناعي على صفحة المنتج:** Salla v2.14.490 أضافت AI-powered product recommendation APIs. `app/[slug]/products/[productId]/page.tsx` لا يعرض أي "منتجات ذات صلة". إضافة قسم أفقي قابل للتمرير بـ ProductCard مشابهة يرفع متوسط المنتجات/طلب. يحتاج endpoint جديد أو تعديل على `getProducts()` لإعادة `related`. | `app/[slug]/products/[productId]/page.tsx` | 🟠 عالية | مؤجلة — تحقق API مطلوب |
| 2026-07-26 | competitors/2026-30 | **Multi-coupon chips في سلة التسوق:** Salla v2.14.501 أضافت chips للكوبونات المتعددة. `app/[slug]/cart/page.tsx` لا يدعم سوى كوبون واحد. إضافة دعم chips للكوبونات تحتاج تأكيد دعم الـ backend API للكوبونات المتعددة أولاً. | `app/[slug]/cart/page.tsx` | 🟡 متوسطة | مؤجلة — تحقق API مطلوب |
