...
| 2026-06-28 | competitors/2026-30 | **Shopify Standard Storefront Events:** إطلاق أحداث معيارية من القالب (`cart:lines-update`, `search:update`) تُمكّن التطبيقات والوكلاء من الاستجابة. `ProductViewTracker.tsx` يُغطي product:view — cart وsearch لم يُغطَّيا. | `components/cart/CartDrawer.tsx` + `components/explore/ExploreSearch.tsx` | 🟡 متوسطة | مؤجلة |
| 2026-06-28 | competitors/2026-30 | **Salla Cashback Wallet badge:** Salla تعرض رصيد كاش باك مكتسب من المشتريات في checkout. يُعزز الولاء وتكرار الشراء. يتطلب نظام backend لأرصدة العملاء — قرار مالك المنتج مطلوب أولاً. | `components/checkout/CheckoutClient.tsx` (مرحلة لاحقة) | 🔴 عالية (تأثير) / تعقيد عالٍ | مؤجلة — backend مطلوب |
| 2026-06-28 | competitors/2026-30 | **Salla Carousel-from-Color-Options:** نقر على خيار لون في بطاقة المنتج يُحرّك carousel الصور لإظهار صورة الـ variant المطابق دون مغادرة الكتالوج. يتوقف على توفر بيانات variants+images في API response. | `components/product/ProductCard.tsx` | 🟡 متوسطة | مؤجلة — تحقق API مطلوب |
