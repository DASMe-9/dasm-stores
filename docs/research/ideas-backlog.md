...
| 2026-08-07 | competitors/2026-32 | **Product Disclosures block على صفحة المنتج:** Shopify Dawn 15.5.0 أضافت قسم "Product Disclosures" يعرض الإفصاحات القانونية والتحذيرات كبلوك مستقل قابل للتخصيص على صفحة المنتج. مناسب للمنتجات التي تستلزم تحذيرات (إلكترونيات، مواد غذائية، إلخ). | `app/[slug]/products/[productId]/page.tsx` | 🟢 منخفضة | مؤجلة — sprint planning |
