export function PaymentLogos({ className = "" }: { className?: string }) {
  const logoCard =
    "inline-flex h-9 min-w-[4.5rem] items-center justify-center rounded-lg border border-zinc-200 bg-white px-3 shadow-sm ring-1 ring-black/5 dark:border-zinc-700 dark:bg-white";
      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        <span className={logoCard}>
          <svg viewBox="0 0 80 24" className="h-4 w-auto" aria-label="mada">
            ...
            <text x="32" y="16" fill="#003B71" fontFamily="Arial,sans-serif" fontWeight="bold" fontSize="11">
              mada
            </text>
          </svg>
        </span>
        ...
        <span className="inline-flex h-9 min-w-[4.5rem] items-center justify-center rounded-lg bg-black px-3 shadow-sm ring-1 ring-white/10">
          <svg viewBox="0 0 50 20" className="h-4 w-auto" aria-label="Apple Pay">
            <path
              fill="#fff"
              d="M9.2 3.2c-.5.6-1.3 1-2 1-.1-.8.3-1.6.7-2.1.5-.6 1.3-1 2-1 .1.8-.2 1.5-.7 2.1zm.7 1.1c-1.1-.1-2.1.6-2.6.6-.5 0-1.4-.6-2.3-.6C3.8 4.3 2.7 5 2 6.1.7 8.3 1.6 11.6 2.9 13.4c.6.9 1.4 1.9 2.3 1.9.9 0 1.3-.6 2.4-.6s1.4.6 2.4.6c1 0 1.6-.9 2.2-1.8.7-1 1-2 1-2-.1 0-1.9-.7-1.9-2.8 0-1.8 1.4-2.6 1.5-2.7-.8-1.2-2.1-1.4-2.5-1.4-.1 0-.2 0-.4.1z"
            />
            <text x="18" y="14" fill="#fff" fontFamily="system-ui,-apple-system,sans-serif" fontWeight="600" fontSize="9.5">
              Pay
            </text>
          </svg>
        </span>
        ...
        <span className={logoCard}>
          <svg viewBox="0 0 60 20" className="h-4 w-auto" aria-label="STC Pay">
            <text x="0" y="14" fill="#4F008C" fontFamily="Arial,sans-serif" fontWeight="bold" fontSize="10">
              stc
            </text>
            <text x="22" y="14" fill="#4F008C" fontFamily="Arial,sans-serif" fontWeight="500" fontSize="9">
              pay
            </text>
          </svg>
        </span>

        <span className="inline-flex h-9 min-w-[4.5rem] items-center justify-center rounded-lg bg-[#006FCF] px-3 shadow-sm ring-1 ring-white/10">
          <svg viewBox="0 0 50 16" className="h-3.5 w-auto" aria-label="American Express">
            <text x="2" y="12" fill="#fff" fontFamily="Arial,sans-serif" fontWeight="bold" fontSize="8">
              AMEX
            </text>
          </svg>
        </span>
