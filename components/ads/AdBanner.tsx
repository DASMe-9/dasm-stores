...
/*
  بطاقات المنصّة حين لا يوجد إعلان مباع.
  تصف قدرة قائمة فقط: لا خصمًا لم يُعلَن، ولا حجم جمهور لا نستطيع إثباته،
  ولا وعدًا بمضاعفة مبيعات. عرضٌ لا يتحقّق يكلّف الثقة أكثر ممّا يكسب النقرة.
*/
const FALLBACK_ADS: Ad[] = [
  {
    id: "promo-1",
    title: "أعلن عن متجرك داخل منصّة داسم",
    description: "حملات تُعرض على أسطح داسم، بتقارير ظهور ونقر ونتائج",
    cta_text: "ابدأ حملتك",
  ...
  {
    id: "promo-2",
    title: "إعلانات مستهدفة بميزانية تحدّدها أنت",
    description: "ادفع بالنقرة أو بالظهور، وأوقف الحملة متى شئت",
